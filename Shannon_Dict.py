...
Help={'-iCNR-':'Reference C/N [dB]\n\nReference Carrier to Noise Ratio in decibels : 10 log (C/N), where C is the '
    ...
    '-iCNRlin-':'C / N = C / (N\N{SUBSCRIPT ZERO}.B) [Linear Format]\n\nReference Carrier to Noise Ratio in linear '
                'format, it\'s the value used Shannon\'s formula',
    ...
    'Advanced': 'Advanced information aiming at trigerring reflection and debate\n\nThe model assumes that the'
        'communication channel is \"AWGN\", just Adding White Gaussian Noise to the signal.'
        'This noise is supposed to be random and white which means that noise at a given time is independent of '
        'noise at any other time, this implies that the noise has a flat and infinite spectrum.'
        'This noise is also supposed to be Gaussian which means that its probability density function follows a '
        'Gaussian law, with a variance which associated to the Noise\'s power.'
        'Although these assumptions seem very strong, they are quite accurately matching with the cases of interest. '
    ...
    'Help': 'Recommendations for using the tool\n\nThe first purpose of the tool is educational, allowing people to '
            ...
            'The user should try multiple values in all the fields one per one, to explore the graphs and try to '
            ...
            ' can be copy/pasted for further usage. This window can also be used as a notepad.'
    }

Help2={'-iFreq-':'Frequency [GHz]\n\nFrequency of the electromagnetic wave supporting the communication in GHz '
                 '(billions of cycles per second).\n In downlink (satellite to terminal), the frequency bands are '
                 'typically : L: , S : , C: , Ku : 12 GHz, Ka : 19 GHz',
        ...
        '-iSBeam-':'Satellite Half Power Beam Diameter [\N{DEGREE SIGN}]\n\nBeam diameter expressed as an angle at '
                   ...
                   'Typical beam size : 0.4-1.4 degrees for HTS satellites, 3..6 degrees for DTH satellites.',
        ...
        '-iPath-':'Path Lenght [km]\n\nDistance in kilometers from the satellite to the customer\'s terminal. '
                  ...
                  'the terminal.\nMinimum distances : GEO : 36000 km, O3B : 8000 km, Starlink : 590 km,\nTypical '
        ...
        '-iLoss-':'Output Section Losses [dB]\n\nLoss of signal\'s power in the path connecting the HPA to the '
                  'antenna. This loss is assocaited with filters, waveguide sections, switches ...\n'
        ...
        '-iSCIR-':'Satellite C/I [dB]\n\n Signal impairment associated with satellite implementation,'
                  ...
                  'noise ...',
        '-iFade-':'Rain & Gaz Attenuation [dB]\n\n Rain is affecting radio wave propagation, with a signal attennuating '
                  ...
                  'attenuation is typically 0.6 dB. The rain and gaz attenuation depends on the actual geographical '
                  'location and on actual weather events. By nature, it is is thus statistical (considering the past) '
                  'or probabilistic (considering the future). All effects included, here are typical attenuation '
                  'figures not exceeded for 0.1% of the time in Europe : Ku: dB, Ka: dB, Q: dB \n',
        ...
        '-iSGain-':'Satellite Antenna Gain​\n\nAn antenna concentrating the signal in the direction of the users is '
                   ...
                   'Antenna gains without units but can be expressed in dB for convenience : dBi = dB relative to'
        ...
        '-iEIRP-':'Equivalent Isotropic Radiated Power\n\n The product Power x Gain expressed in Watts is a convenient '
                  ...
                  'considered. There is no "power creation" of course : for the directive antenna, the integral of the '
                  'radiated signal over a sphere centered on the antenna is at best equal to the input power '
                  '(lossless antenna).\n'
        ...
        '-iPLoss-':'Free Space Loss\n\n'
                   'Assuming communication in free space (thus also in the vacuum), this figure charcterises the effect'
                   ' of the distance from the satellite ot the termial. It gives an attenuation equivalent to the '
                   ...
                   'Note that the vacuum is lossless, this "attenuation" is simply associated with the fact that only '
        ...
        '-iPFD-':'Power Flux Density, Clear Sky\n\n Signal power per square meter at the terminal side. '
                 ...
                 'of the terminal\'s antenna. Note that if the surface of antenna is not perpendicular to the '
                 'propagation direction of the radio wave, the effective surface presnted to the wave is reduced '
        ...
        '-iCPE-':'Customer Antenna Size [m]\n\nSize of the terminal antenna. A basic parabolic antenna with state of '
                 'the art efficiency is assumed. The main source of noise is in general the terminal\'s radio front end'
        ...
        '-iCGain-':'Customer Antenna Effective Area and G/T\n\n The effective area in square meters is expressing the '
                   ...
                   'athmospheric attenuator. In case of rain, the signal is punished twice : the '
        ...
        '-iRXPow-':'RX Power at Antenna Output\n\n Power at antenna output before amplification. '
        ...
        '-iBRinf-':'Bit Rate at infinite Bandwidth\n\nBit Rate theoretically achievable when the signal occupies an '
                   'infinite Bandwidth, this value is a useful asympotical limit. The corresponding value, deduced '
        ...
        '-iRO-':'Nyquist Filter Rolloff [%]\n\n'
                ...
                'Bandwidth occupied. Theoretically, filtering can be "brickwall", one symbol per second passing in 1 Hertz.'
                'Practically, an excess of bandwdith is required, also called "Roll-Off of the filter. '
        ...
        '-iCIR-':'Receiver\'s C/I [dB]\n\n Signal impairment associated with terminal implementation,'
                'expressed as a signal to nois ratio to be combined with the intrincic Signal to Noise Ratio affecting the link. '
                'Impairements are multiple : Phase Noise of the radio front end, Quantization Noise of the receiver\'s '
                'Analog to Digital Conversion, effect of imperfect synchronisation ... '
                'Typical values of total implementation impairement range from 15 to 25 dB',
        '-iPenalty-':'Modulation and Coding Penalty vs theory [dB]\n\nTurbo and Turbo-like Codes are known for getting '
                     ...
                     'Orginal Turbo codes designed with higher residual bit error rates can get much closer '
        ...
        '-iOH-':'Higher Layers Overhead [%]\n\n The practical usage of information bits is based on a breakdown '
                ...
                ' the GSE standard costs a few percents of net bit rate, spend in framing structures, integrity '
                'control bits ...\n'
                'In a modern efficient satellite forward communication system the overhead to IP costs typically \%',
        '-iNBW-':'Nyquist Bandwidth\n\nThe modulated carrier is passing bits in groups mapped on modulation symbols.'
                ...
                'To pass a limited bandwidth channel symbol have to be mapped on pulses "filtered" to limit the '
                'Bandwidth occupied. Theoretically, filtering can be "brickwall", one symbol per second passing in 1 Hertz.'
                'Practically, an excess of bandwdith is required, also call "Roll-Off of the filter. '
                'The filter used is also designed to respect the symmetry condition expressed in the Nyquist Criterion '
                'avoiding inter-symbol interferences. Such a filter is thus called Nyquist Filter. '
                'and the mimimum theoretical bandwidth (Roll-Off = zero) is called Nyquist Bandwidth.',
        ...
        '-iCNRnyq-':'Signal to Noise Ratio in Nyquist BW\n\nRatio of the Signal Power and the Noise Power Captured '
                ' in the Nyqueist Bandwidth = Available Bandwidth / ( 1 + Roll-Off).',
        '-iCNRrcv-':'Signal to Noise Ratio at Receiver Output\n\nRatio of the Signal Power and the total Noise Power'
                'captured along the compelete communication chain (at receiver ouptut). This ratio is the relevant one'
        ...
        '-Satellite-':'The Shannon Limit is also a very powerful tool to analyse communication systems\' design '
                      'trade offs. Using the C/N evaluated for a real communication link gives a good estimate of the '
                      'capacity achievable. Applying in addition the known average penalty of real modulation and '
                      'coding schemes makes it accurate enough for initial systems evaluations. The analytic formulas '
                      'derived from the Shannon Limit for given spectral efficiencies are also of great help. ',
        'Advanced':'https://en.wikipedia.org/wiki/Nyquist_ISI_criterion\n'
        ...
        'Help':'Recommendations for using the tool\n\nThe first purpose of the tool is educational, allowing people to '
               'better understand the physics of communications and the role of key parameters.'
               'The user should try multiple values in all the fields one per one, explore the graphs and try '
